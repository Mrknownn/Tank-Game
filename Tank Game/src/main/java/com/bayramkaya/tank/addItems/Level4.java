...
public class Level4 {
    public static void addObjects() {
        ...
        IronWall ironWall6 = new IronWall(299, 200);
        IronWall ironWall7 = new IronWall(299, 150);
        IronWall ironWall8 = new IronWall(299, 400);
        IronWall ironWall9 = new IronWall(299, 450);
        ...
        com.bayramkaya.tank.Main.gameObjects.add(ironWall6);
        com.bayramkaya.tank.Main.gameObjects.add(ironWall7);
        com.bayramkaya.tank.Main.gameObjects.add(ironWall8);
        com.bayramkaya.tank.Main.gameObjects.add(ironWall9);
        ...
        RegularTank regularTank = new RegularTank(0, 0);
        ArmoredTank armoredTank2 = new ArmoredTank(400, 0);
        RandomTank randomTank1 = new RandomTank(0, 0);
        RegularTank regularTank1 = new RegularTank(400, 0);
        RandomTank randomTank = new RandomTank(0, 0);
        RegularTank regularTank2 = new RegularTank(200, 0);
        RegularTank regularTank3 = new RegularTank(600, 0);
        RandomTank randomTank2 = new RandomTank(200, 0);
        RandomTank randomTank3 = new RandomTank(400, 0);
        RandomTank randomTank4 = new RandomTank(600, 0);
        com.bayramkaya.tank.Main.tanks.add(randomTank2);
        com.bayramkaya.tank.Main.tanks.add(randomTank3);
        com.bayramkaya.tank.Main.tanks.add(regularTank);
        com.bayramkaya.tank.Main.tanks.add(regularTank3);
        ...
        com.bayramkaya.tank.Main.tanks.add(randomTank4);
