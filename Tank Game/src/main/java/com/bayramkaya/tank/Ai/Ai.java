package com.bayramkaya.tank.Ai;
...
public class Ai {
    public void aiBullet(com.bayramkaya.tank.Bullet.Bullet bullet, Group root, Stage stage) {
    ...
    public boolean aiBulletCollision(com.bayramkaya.tank.Bullet.Bullet bullet, Group root, Stage stage) {
        ...
        for (GameObject gameObject : Main.gameObjects) {
            if (gameObject instanceof com.bayramkaya.tank.Bullet.Bullet || gameObject instanceof ArmoredTank || gameObject instanceof RegularTank || gameObject instanceof RandomTank || gameObject instanceof Grass) {
                continue;
            }
            if (bulletX > gameObject.getX() - 8 && bulletX < gameObject.getX() + 48 && bulletY > gameObject.getY() - 8 && bulletY < gameObject.getY() + 48) {
                ...
                if (gameObject instanceof com.bayramkaya.tank.flag.Flag) {
                    showCollosionAnimationFlag(root, stage, (com.bayramkaya.tank.flag.Flag) gameObject);
                }
                return false;
            }
        }
