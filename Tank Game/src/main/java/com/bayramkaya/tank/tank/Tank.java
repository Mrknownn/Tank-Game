package com.bayramkaya.tank.tank;

import com.bayramkaya.tank.gameObjects.GameObject;
import com.bayramkaya.tank.move.Collision;
    ...
    public void update(Tank playerTank) {
        if (playerTank instanceof PlayerTank) {
            if (playerTank.getDirection() == 2 && playerTank.getSpeed() != 0) {
                if (com.bayramkaya.tank.move.Collision.checkCollision(playerTank)) {
            ...
            if (playerTank.getDirection() == 2 && playerTank.getSpeed() != 0) {
                if (com.bayramkaya.tank.move.Collision.checkCollisionOtherTank(playerTank)) {
                    playerTank.setY(playerTank.getY() + playerTank.getSpeed());
                }
            } else if (playerTank.getDirection() == 8 && playerTank.getSpeed() != 0) {
                if (com.bayramkaya.tank.move.Collision.checkCollisionOtherTank(playerTank)) {
