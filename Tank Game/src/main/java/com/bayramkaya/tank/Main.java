package com.bayramkaya.tank;

import com.bayramkaya.tank.Board.BoardDesign;
import com.bayramkaya.tank.Board.Draw;
...
import com.bayramkaya.tank.move.BulletMove;
import com.bayramkaya.tank.move.HandleKey;
import com.bayramkaya.tank.tank.*;
...
public class Main extends Application {
    ...
    public static ArrayList<ArmoredTank> armoredTanks = new ArrayList<>();
    public static ArrayList<PlayerTank> playerTanks = new ArrayList<>();
    public static ArrayList<RandomTank> randomTanks = new ArrayList<>();
    public static ArrayList<RegularTank> regularTanks = new ArrayList<>();
    ...
    public void cntTank(Group group, Stage stage, PlayerTank playerTank) {
        ...
        if (cnt == 0 && tanks.isEmpty() && armoredTanks.isEmpty() && randomTanks.isEmpty() && regularTanks.isEmpty() && gameObjects.contains(playerTank)) {
